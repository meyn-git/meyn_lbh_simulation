...
class LiveBirdsHandlingTheme extends ThemeExtension<LiveBirdsHandlingTheme> {
  ...
  LiveBirdsHandlingTheme lerp(
    covariant ThemeExtension<LiveBirdsHandlingTheme>? other,
    double t,
  ) {
    ...
    return LiveBirdsHandlingTheme(
      ...
      withAwakeBirdsColor: Color.lerp(
        withAwakeBirdsColor,
        other.withAwakeBirdsColor,
        t,
      )!,
      withBirdsBeingStunnedColor: Color.lerp(
        withBirdsBeingStunnedColor,
        other.withBirdsBeingStunnedColor,
        t,
      )!,
      withStunnedBirdsColor: Color.lerp(
        withStunnedBirdsColor,
        other.withStunnedBirdsColor,
        t,
      )!,
      withoutBirdsColor: Color.lerp(
        withoutBirdsColor,
        other.withoutBirdsColor,
        t,
      )!,
    );
  }

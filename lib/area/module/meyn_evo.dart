...
class EvoBuilder extends ModuleVariantBuilder {
  ...
  @override
  late final List<ModuleVariantBuilder> children = [standard, usa];

  EvoBuilder({required super.parent})
    : super(
        values: ModuleVariantValues(
          family: 'Evo',
          footprint: const SizeInMeters(xInMeters: 1.2, yInMeters: 2.4),
          compartment: CompartmentWithDoor(birdFloorSpaceInSquareMeters: 1.311),

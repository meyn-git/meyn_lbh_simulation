...
// class TurnToInFeed2 extends TurnToFeedIn {
//   @override
...
//     var neighborDirection = rotatingConveyor.bestOutFeedTurnPosition;
//     var receivingNeighbor = area.neighboringCell(
//         rotatingConveyor, neighborDirection!) as StateMachineCell;
//     transportedModuleGroup!.position = ModulePositionDeprecated.betweenCells(
...
//       (transportedModuleGroup!.position as ModulePositionDeprecated).source != rotatingConveyor;
// }
...
//     rotatingConveyor as ModuleRotatingConveyorSingleOut;
//     rotatingConveyor.waitingModuleGroup!.position =
//         ModulePositionDeprecated.forCel(rotatingConveyor);
...
//     var receivingNeighbor = area.neighboringCell(
//         rotatingConveyor, neighborDirection!) as StateMachineCell;
//     rotatingConveyor.moduleGroup!.position = ModulePositionDeprecated.betweenCells(
//         source: rotatingConveyor, destination: receivingNeighbor);
//   }
